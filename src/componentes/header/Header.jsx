	...
	return (
		<header>
			<div className='contenedor-header-1 bg-dark py-2 '>
				<h6 className='titulo-header text-center text-white'>
					❤ VALENTINE`S DAYS ❤
				</h6>
			</div>
			...
			<div className='contenedor-header-3 row px-2'>
				<nav class="Navbar-contenedor navbar navbar-expand-lg navbar-light py-2 d-flex flex-row justify-content-around align-items-center">
						...
						<ul className="navbar-nav mr-auto align-items-center">
							<li className="nav-item active align-items-center">
								<div className="dropdown align-items-center">
									<a
										href="#"
										className="d-flex align-items-center text-dark text-decoration-none px-1 dropdown-toggle"
					...
					<h1 className='header-loveboo text-center align-items-center '>
						LOVEBOO
					</h1>
					<div className='d-flex flex-row gap-2 align-items-center'>
					...
					<div className='d-flex flex-row gap-2 align-items-center'>
						<form className="form my-2 my-lg-0 ">
							...
							/>
							<button
								className="btn btn-border-none my-2 my-sm-0"
								type="submit"
							>
								<i className="header-texto-a fa-solid fa-magnifying-glass"></i>
							</button>
						</form>
						<span>
							<i className="header-texto-a fa-solid fa-user"></i>
						</span>
						<span>
							<i className="header-texto-a fa-solid fa-cart-shopping"></i>
						</span>
					</div>
				</nav>
			</div>
