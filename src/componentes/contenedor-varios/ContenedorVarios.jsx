	...
	return (
		<div className='contenedor-varios mb-3 gap-4'>
			<ImagenContenedorCelu
				...
				href='#'
				texto='BASICOS DE SIEMPRE'
			/>
			<ImagenContenedorTablet
				src='https://dummyimage.com/200x200/e34a12/fff'
				href='#'
				texto='TODOS LOS PRODUCTOS'
			/>
			<ImagenContenedorDesktop
				src='https://dummyimage.com/100x100/e31212/fff'
				href='#'
				texto='DENIM & DRILL'
			/>
		</div>
